...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/quarry/06d2a6c/install.sh | sh
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/quarry/06d2a6c/install.sh -o install.sh
