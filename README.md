...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/quarry/b805ce8/install.sh | sh
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/quarry/b805ce8/install.sh -o install.sh
...
curl -fsSL https://raw.githubusercontent.com/punt-labs/quarry/b805ce8/install.sh | sh -s -- --network
```
