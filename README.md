...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/quarry/688d75c/install.sh | sh
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/quarry/688d75c/install.sh -o install.sh
