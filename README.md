...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/quarry/e7a57f7/install.sh | sh
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/quarry/e7a57f7/install.sh -o install.sh
