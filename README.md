...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/quarry/3ba762a/install.sh | sh
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/quarry/3ba762a/install.sh -o install.sh
