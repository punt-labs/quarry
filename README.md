...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/quarry/7275801/install.sh | sh
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/quarry/7275801/install.sh -o install.sh
