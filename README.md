...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/quarry/2c6047e/install.sh | sh
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/quarry/2c6047e/install.sh -o install.sh
