...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/quarry/268c8ce/install.sh | sh
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/quarry/268c8ce/install.sh -o install.sh
...
curl -fsSL https://raw.githubusercontent.com/punt-labs/quarry/268c8ce/install.sh | sh -s -- --network
```
