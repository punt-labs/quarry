...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/quarry/e25827e/install.sh | sh
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/quarry/e25827e/install.sh -o install.sh
