...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/quarry/edf6e41/install.sh | sh
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/quarry/edf6e41/install.sh -o install.sh
...
curl -fsSL https://raw.githubusercontent.com/punt-labs/quarry/edf6e41/install.sh | sh -s -- --network
```
