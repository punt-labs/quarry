...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/quarry/1fdc9da/install.sh -o install.sh
...
curl -fsSL https://raw.githubusercontent.com/punt-labs/quarry/1fdc9da/install.sh | sh -s -- --network
```
