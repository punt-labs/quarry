...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/quarry/937f5e6/install.sh | sh
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/quarry/937f5e6/install.sh -o install.sh
