...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/quarry/a1f0a6c/install-server.sh | sh
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/quarry/a1f0a6c/install-client.sh | sh
