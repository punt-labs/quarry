...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/quarry/6477a48/install.sh | sh
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/quarry/6477a48/install.sh -o install.sh
