...
1. Call `mcp__quarry-dev__find` with a query derived from the arguments. If the arguments look like a document name (has a file extension like `.pdf`, `.md`, `.py`), also set `document_filter` to the document name.
