...
Facade        & \modpath{db/facade.py}        & \texttt{Database} ---
                ...
                schema, and optimizer subsystems (DES-010). \\
...
Chunk search  & \modpath{db/chunk\_search.py}  & Vector-similarity
                search under the cosine metric (the vector channel of
                hybrid search). \\
...
The \modpath{retrieval/} package is a deliberate seam: the same
